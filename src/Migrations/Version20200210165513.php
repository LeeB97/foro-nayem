 ...
 */
final class Version20200210165513 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE publicacion (id INT AUTO_INCREMENT NOT NULL, categoria_id INT NOT NULL, user_id INT NOT NULL, titulo VARCHAR(255) NOT NULL, contenido LONGTEXT NOT NULL, fecha_publicacion DATETIME NOT NULL, imagen VARCHAR(255) DEFAULT NULL, INDEX IDX_62F2085F3397707A (categoria_id), INDEX IDX_62F2085FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE comentario (id INT AUTO_INCREMENT NOT NULL, publicacion_id INT NOT NULL, user_id INT NOT NULL, contenido LONGTEXT NOT NULL, fecha_publicacion DATETIME NOT NULL, INDEX IDX_4B91E7029ACBB5E7 (publicacion_id), INDEX IDX_4B91E702A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
